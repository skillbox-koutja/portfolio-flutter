...
final fontSize20Bold = fontSize20.copyWith(fontWeight: FontWeight.bold);
const fontSize24 = TextStyle(color: textColor, fontSize: 24);
final fontSize24Bold = fontSize24.copyWith(fontWeight: FontWeight.bold);
